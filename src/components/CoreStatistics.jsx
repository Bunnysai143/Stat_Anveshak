    ...
    switch (stat) {
      ...
      case "median":
        return {
          ...
          description: "The median is the middle value when the data is sorted in ascending order. It is less sensitive to outliers compared to the mean."
        };
      case "mode":
        return {
      ...
      case "stdDev":
        return {
          ...
          description: "The standard deviation is the square root of the variance and provides a measure of the spread of data in the same units as the data."
        };
      case "range":
        return {
          formula: "Range = Max value - Min value",
          description: "The range is the difference between the largest and smallest values in the dataset."
        };
      case "skewness":
        return {
      ...
      case "q1":
        return {
          ...
          description: "The first quartile (Q1) is the median of the lower half of the dataset (the 25th percentile)."
        };
      case "q3":
        return {
          formula: "Q3 = 75th percentile of the data",
          description: "The third quartile (Q3) is the median of the upper half of the dataset (the 75th percentile)."
        };
      case "iqr":
        return {
          formula: "IQR = Q3 - Q1",
          description: "The interquartile range (IQR) is the difference between Q3 and Q1."
        };
      case "rms":
        return {
          formula: "RMS = √((Σ(x²)) / n)",
          description: "The root mean square (RMS) is a measure of the magnitude of the dataset values."
        };
      case "sumOfSquares":
        return {
          formula: "Sum of Squares = Σ((x - mean)²)",
          description: "The sum of squares is the total of the squared differences between each data point and the mean."
        };
      case "min":
        return {
